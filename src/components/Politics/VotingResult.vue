...
export default {
  ...
  computed: {
    ...
    forPercentage() {
      return this.totalVotes ? (this.votesFor / this.totalVotes) * 100 : 0;
    },
    againstPercentage() {
      return this.totalVotes ? (this.votesAgainst / this.totalVotes) * 100 : 0;
    },
    abstainPercentage() {
      return this.totalVotes ? (this.votesAbstain / this.totalVotes) * 100 : 0;
    }
  }
}
</script>
